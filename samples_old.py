...
#XSWeight      = 'XSWeight'
#SFweight      = 'puWeight*TriggerEffWeight_3l*EMTFbug_veto*Lepton_RecoSF[0]*Lepton_RecoSF[1]*Lepton_RecoSF[2]*(Lepton_tightMuon_'+muWP+'_IdIsoSF'+'[0] || Lepton_tightElectron_'+eleWP+'_IdIsoSF'+'[0])'
...
XSWeight      = 'XSWeight'
SFweight      = 'puWeight*TriggerEffWeight_3l*EMTFbug_veto*Lepton_RecoSF[0]*Lepton_RecoSF[1]*Lepton_RecoSF[2]*(Lepton_tightMuon_'+muWP+'_IdIsoSF'+'[2] || Lepton_tightElectron_'+eleWP+'_IdIsoSF'+'[2])'
#SFweight      = 'SFweight'+Nlep+'l'
GenLepMatch   = 'GenLepMatch'+Nlep+'l'
