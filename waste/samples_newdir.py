...
DataRun = [
            ['B','Run2017B-Nano14Dec2018-v1'] ,
                                                ['C','Run2017B-Nano14Dec2018-v1'] ,
                                                ['D','Run2017B-Nano14Dec2018-v1'] ,
                                                ['E','Run2017B-Nano14Dec2018-v1'] ,
                                                ['F','Run2017B-Nano14Dec2018-v1']
...
samples['Vg'] = {    'name'   :  getSampleFiles(directory,'Wg_MADGRAPHMLM',False,'nanoLatino_')
                               + getSampleFiles(directory,'Wg_AMCNLOFXFX',False,'nanoLatino_'), 
...
addSampleWeight(samples,'VgS','Wg_AMCNLOFXFX',     '(Gen_ZGstar_mass >0)')
...
samples['VVV'] = {    'name'   : getSampleFiles(directory,'WZZ',False,'nanoLatino_') 
