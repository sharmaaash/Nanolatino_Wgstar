...
supercut = 'Lepton_pt[0]>25 && Lepton_pt[1]>8 && Lepton_pt[2]>8 && (Lepton_isTightElectron_mvaFall17Iso_WP90[0]>0.5) && (Lepton_isTightMuon_cut_Tight_HWWW[1]>0.5) && (Lepton_isTightMuon_cut_Tight_HWWW[2]>0.5)'
...
cuts['ZTomm_mpmet']  = '  mpmet > 25  \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*13*13)) && fabs( mllWgSt - 3.1) > 0.1 '


cuts['ZTomm_mpmet_Zpeak']  = '  mpmet > 25  \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*13*13)) && fabs( mllWgSt - 91.2) < 10. '

cuts['ZTomm_mpmet_WgSt']  = '  mpmet > 25  \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*13*13)) && fabs( mllWgSt - 3.1) > 0.1 &&  mllWgSt < 4. && mllWgSt >0.'


cuts['ZTomm_mpmet_WgSt_gt0p1']  = '  mpmet > 25  \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*13*13)) && fabs( mllWgSt - 3.1) > 0.1  && mllWgSt < 4. && mllWgSt >0.1'
