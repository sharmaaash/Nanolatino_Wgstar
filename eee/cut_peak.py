...
#cuts['ZToeeWTom']  = '   Lepton_pt[0] > 40 && Lepton_pt[1] > 30 && Lepton_pt[2] > 30  \
...
cuts['ZToeeWToe_puppiMET']  = ' PuppiMET_pt > 30 &&   Lepton_pt[0] > 40   \
...
cuts['ZToeeWToe_mpmet']  = ' mpmet > 30 &&   Lepton_pt[0] > 40   \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*11*11)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0)  && Lepton_isTightElectron_mvaFall17V1Iso_WP90[0]>0.5 && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 '
 
cuts['ZToeeWToe_mtw']  = ' mtw1 > 30 &&   Lepton_pt[0] > 40   \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*11*11)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0)  && Lepton_isTightElectron_mvaFall17V1Iso_WP90[0]>0.5 && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 '
