...
void calcNormLoHi(){
  ...
  TString fileName("plots_WgSt_ZmmWl.root");
  cout<<fileName<<endl;
  ...
  enum idxChannel{mmm,emm,eem,eee};
  ...
  TString tstring_mllWgSt("/mllTwoThree/");
  TString cut("TGGmpmet_NoJpsi");
  ...
  double nZmllWgSt_H_VgS     ;  double nZmllWgSt_L_VgS  ;
  ...
  for(int i(0); i<NdecayCh; i++){
    ...
    hmllWgSt_VgS     = (TH1F*)myF->Get(histBaseZmllWgSt+"histo_VgS");
  ...
  // Calculate the efficiency
    ...
    nZmllWgSt_H_VgS     = hmllWgSt_VgS     ->Integral(effBinZmllWgSt_H_L, effBinZmllWgSt_H_H);
    ...
    nZmllWgSt_L_VgS     = hmllWgSt_VgS     ->Integral(effBinZmllWgSt_L_L, effBinZmllWgSt_L_H);
    ...
    nZmllWgSt_H_DATA = nZmllWgSt_H_DATA - nZmllWgSt_H_ggWW - nZmllWgSt_H_Vg - nZmllWgSt_H_VVV - nZmllWgSt_H_top 
			- nZmllWgSt_H_DY - nZmllWgSt_H_VZ;

    nZmllWgSt_L_DATA = nZmllWgSt_L_DATA - nZmllWgSt_L_ggWW - nZmllWgSt_L_Vg - nZmllWgSt_L_VVV - nZmllWgSt_L_top 
			- nZmllWgSt_L_DY - nZmllWgSt_L_VZ;
    ...
    NorFactmllWgSt_H_WZ01[i]    = nZmllWgSt_H_DATA/(nZmllWgSt_H_VgS + nZmllWgSt_H_WZ);
    ...
    NorFactmllWgSt_L_WZ01[i]    = nZmllWgSt_L_DATA/(nZmllWgSt_L_VgS + nZmllWgSt_L_WZ)/NorFactmllWgSt_H_WZ01[i];
  ...
  // Zpeak mllmin3l ====================================
    histBaseZmllmin3l=channel[i]+"_"+cut+"/mllTwoThree/";
    ...
    hmllmin3l_VgS     = (TH1F*)myF->Get(histBaseZmllmin3l+"histo_VgS");
  ...
  // Calculate the efficiency
    ...
    nZmllmin3l_VgS     = hmllmin3l_VgS     ->Integral(effBinZmllmin3l_L, effBinZmllmin3l_H);
    ...
    nZmllmin3l_H_DATA = nZmllmin3l_DATA - nZmllmin3l_ggWW -
                        - nZmllmin3l_Vg - nZmllmin3l_VVV - nZmllmin3l_top 
			- nZmllmin3l_DY - nZmllmin3l_VZ;
    ...
    NorFactmllmin3l_WZ01[i]    = nZmllmin3l_H_DATA/(nZmllmin3l_VgS + nZmllmin3l_WZ);
