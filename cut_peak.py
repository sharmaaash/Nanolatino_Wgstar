...
supercut = 'Lepton_pt[0]>30 && Lepton_pt[1]>30 && Lepton_pt[2]>30 \
              '
...
cuts['ZToeeWTom']  = '   PuppiMET_pt > 30  \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*11*11)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0)  && (Lepton_isTightMuon_cut_Tight_HWWW[0]>0.5 ) && Lepton_isWgs[1]==1 && Lepton_isWgs[2]==1 '
cuts['ZTommWToe']  = '   PuppiMET_pt > 30  \
                          && ((fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 11*13*13)) && (Lepton_pdgId[1] * Lepton_pdgId[2] < 0)  && (Lepton_isTightElectron_mvaFall17V1Iso_WP90[0]>0.5) && Lepton_isWgs[1]==1 && Lepton_isWgs[2]==1 '
