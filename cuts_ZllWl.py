...
cuts['hww2l2v_13TeV_WgS_mmm']  = ' \
                ...
                && mllTwoThree > 0 \
                && (Lepton_isTightMuon_cut_Tight_HWWW[0]>0.5 || Lepton_isTightElectron_mvaFall17Iso_WP90[0]>0.5) && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 \
...
cuts['hww2l2v_13TeV_WgS_mee']  = ' \
                ...
                && Lepton_pdgId[1]*Lepton_pdgId[2]<0   \
                && mllTwoThree > 0 \
                && (Lepton_isTightElectron_mvaFall17Iso_WP90[0]>0.5 || Lepton_isTightMuon_cut_Tight_HWWW[0]>0.5) && Lepton_isWgs[1]>0.5 && Lepton_isWgs[2]>0.5 \
                &&  fabs(mllTwoThree - 3.1) > 0.1 \
                '
...
cuts['hww2l2v_13TeV_WgS_eee']  = ' \
                   abs(Lepton_pdgId[0]) == 11 \
                && abs(Lepton_pdgId[1]) == 11   \
                && abs(Lepton_pdgId[2]) == 11   \
                && Lepton_pdgId[1]*Lepton_pdgId[2]<0   \
                && mllTwoThree > 0 \
                && (Lepton_isTightElectron_mvaFall17Iso_WP90[0]==1) && Lepton_isWgs[1]==1 && Lepton_isWgs[2]==1 \
                &&  fabs(mllTwoThree - 3.1) > 0.1 \
                '
