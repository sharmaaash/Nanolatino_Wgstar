...
cuts['ZTomm_mpmet_Zpeak']  = '  mpmet > 25  \
                          && (fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*13*11) && fabs( mllWgSt - 91.2) < 10 '

cuts['ZTomm_mpmet_WgSt']  = '  mpmet > 25  \
                          && (fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*13*11) && fabs( mllWgSt - 3.1) > 0.1 && mllWgSt < 4. && mllWgSt >0.'


cuts['ZTomm_mpmet_WgSt_gt0p1']  = '  mpmet > 25  \
                          && (fabs(Lepton_pdgId[0] * Lepton_pdgId[1] * Lepton_pdgId[2])== 13*13*11) && fabs( mllWgSt - 3.1) > 0.1 && mllWgSt < 4. && mllWgSt >0.1'
